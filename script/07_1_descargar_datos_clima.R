...
periodo <- c('2024-08-01',substr(now(),1,10))
...
data_clima <- temp |>
  ...
  ungroup() |>
  mutate(temporada = ifelse(fecha > '2023-06-01','2023-2024','2022-2023'), .before = fecha)

write_rds(data_clima, 'data/processed/clima.rds')
