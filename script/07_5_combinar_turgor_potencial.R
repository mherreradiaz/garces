...
data_turgor <- read_rds('data/processed/turgor_procesado.rds')
...
data_potencial_dia <- read_rds('data/processed/potencial.rds') |> 
...
data_potencial_hora <- read_rds('data/processed/potencial_horario.rds') |> 
...
write_rds(data_cor_dia,'data/processed/turgor_potencial_dia.rds')
write_rds(data_cor_hora,'data/processed/turgor_potencial_hora.rds')
